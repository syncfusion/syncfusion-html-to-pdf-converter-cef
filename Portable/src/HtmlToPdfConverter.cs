...
namespace Syncfusion.HtmlConverter
{
    ...
    public class HtmlToPdfConverter
    {
        ...
        internal CefConverter UpdateCefSettings(CefConverterSettings settings)
        {
            ...
            CefConverter.CommandLineArguments = settings.CommandLineArguments;
            CefConverter.EnableJavaScript = settings.EnableJavaScript;
            CefConverter.EnableLocalFileAccess = settings.EnableLocalFileAccess;
            CefConverter.Scale = settings.Scale;
            CefConverter.EnableBookmarks = settings.EnableBookmarks;
            CefConverter.EnableForm = settings.EnableForm;
            CefConverter.EnableOfflineMode = settings.EnableOfflineMode;
            CefConverter.EnableToc = settings.EnableToc;
            CefConverter.Cookies = settings.Cookies;
            CefConverter.WindowStatus = settings.WindowStatus;
    ...
    public class CefConverterSettings : IHtmlConverterSettings
    {
        ...
        private CefCommandLineArguments m_commandLineArguments = new CefCommandLineArguments();
        ...
        private CookieCollection m_cookie = new CookieCollection();
        ...
        public bool EnableLocalFileAccess
        {
            get
            {
        ...
        public CefCommandLineArguments CommandLineArguments
        {
            get
            {
        ...
        public class CefCommandLineArguments : List<string>
        {
        }
        #endregion
